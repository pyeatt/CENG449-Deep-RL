...
class SinglePendulumCart:
    def __init__(self, m1, m2, I2, l, w1, h1, w2, l2):
        ...
        self.p2 = patches.Rectangle((-w2/2, 0), w2, l2, color='yellow')
...
def main():
    ...
    def init_patches():
        ...
        patches_collection = mlp.collections.PatchCollection(patches, match_original=True)
